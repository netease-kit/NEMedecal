...
Component({
  ...
  data: {
    localAlbumImages: [
      '/images/chatroom/album-emoji.png',
      '/images/chatroom/album-ajtd.png',
      '/images/chatroom/album-xxy.png',
      '/images/chatroom/album-lt.png',
    ],
    albumArr: [],
    currentAlbum: 'emoji',
    emojiList: {},
  ...
  attached: function () {
    let currentAlbumKeys = this.splitAlbumKeys(
      Object.keys(EmojiObj.emojiList[this.data.currentAlbum]),
      this.data.currentAlbum == 'emoji' ? 23 : 10
    )
    this.setData({
  ...
  methods: {
    ...
    switchAlbum: function (e) {
      ...
      let currentAlbumKeys = this.splitAlbumKeys(
        Object.keys(this.data.emojiList[currentAlbum]),
        currentAlbum == 'emoji' ? 23 : 10,
        currentAlbum
      )
    ...
    splitAlbumKeys: function (arr, space, currentAlbum) {
      ...
      if (currentAlbum == 'emoji' || this.data.currentAlbum == 'emoji') {
        // 只有emoji才添加删除按钮
