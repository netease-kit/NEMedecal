...
let indexReducer = (state = INITIAL_STATE, action) => {
  ...
  switch (action.type) {
    ...
    case 'FriendCard_Update_InfoCard': {
      ...
      tempState.friendCard[card.account] = Object.assign(
        {},
        tempState.friendCard[card.account],
        card
      )
    ...
    case 'FriendCard_Update_NonFriendInfoCard': {
      ...
      tempState.personList[card.account] = Object.assign(
        {},
        tempState.personList[card.account],
        card
      )
      return Object.assign({}, state, tempState)
    }
    ...
    case 'RawMessageList_Recall_Msg': {
      ...
      tempState.rawMessageList[sessionId][msg.time] = Object.assign({}, msg, {
        tip: '此消息已撤回',
        recallText: action.payload.text,
        type: 'tip',
      })
      return Object.assign({}, state, tempState)
    }
    ...
    case 'RawMessageList_OppositeRecall_Msg': {
      ...
      tempState.rawMessageList[sessionId][deleteInfo.time] = Object.assign(
        {},
        deletedMsg,
        {
          type: 'tip',
    ...
    case 'Notification_Team_Apply': {
      ...
      payload.desc +=
        '“' +
        (tempState.groupList[payload.teamId] &&
          tempState.groupList[payload.teamId].name) +
        '”'
      tempState.notificationList.system.push(payload)
      return Object.assign({}, state, tempState)
    }
    ...
    case 'Delete_Single_MessageByAccount': {
      ...
      if (tempState.rawMessageList[accountAndTime.sessionId]) {
        delete tempState.rawMessageList[accountAndTime.sessionId][
          accountAndTime.time
        ]
      }
      return Object.assign({}, state, tempState)
    ...
    case 'Set_Current_Group_And_Members': {
      let tempState = Object.assign({}, state)
      tempState.currentGroup = tempState.groupList[action.payload] || {}
      tempState.currentGroupMembers =
        tempState.groupMemberList[action.payload] || []
      return Object.assign({}, state, tempState)
    }
    // 初始化群组 ， onTeam 回调的所有群
    case 'Init_Groups': {
    ...
    case 'Del_Group': {
      ...
      // 更新群信息
      tempState.groupList[group.teamId] = Object.assign(
        {},
        tempState.groupList[group.teamId],
        { isCurrentNotIn: true }
      )
      // 更新当前群信息
    ...
    case 'Add_Person': {
      ...
      users.map((item) => {
        tempState.personList[item.account] = Object.assign(
          {},
          tempState.personList[item.account],
          item
        )
      })
